...
#ifndef MUMBI__THREADING__TASK__SPECIFIC_THREAD_TIMER_TASK__H
#define MUMBI__THREADING__TASK__SPECIFIC_THREAD_TIMER_TASK__H
...
#endif	// MUMBI__THREADING__TASK__SPECIFIC_THREAD_TIMER_TASK__H
